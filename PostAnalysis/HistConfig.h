...
const TH2DModel EcnThetaCM {"hEcnThetaCM", "E_{CN} vs ThetaCM; E_{^{*18}Ne} [MeV];ThetaCM [#circ]", 200, 4, 9, 720, 0, 180};
const TH2DModel Eff2D {"hEff2D", "2D efficiency;E_{CM} [MeV]; #theta_{CM} [#circ]", 200, 0, 5, 720, 0, 180};
