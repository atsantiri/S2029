...
const TH2DModel EcnThetaCM {"hEcnThetaCM", "E_{CN} vs ThetaCM; E*_{^{18}Ne} [MeV];ThetaCM [#circ]", 200, 4, 9, 200, 0, 180};
const TH2DModel EcmThetaCM {"hEcmThetaCM", "E_{CM} vs ThetaCM; E_{CM} [MeV];ThetaCM [#circ]", 200, 0, 5, 200, 0, 180};
const TH2DModel EcnPhiLab {"hEcnPhiLab", "E_{CN} vs PhiLab; E*_{^{18}Ne} [MeV];PhiLab [#circ]", 200, 4, 9, 200, 0, 180};
const TH2DModel EcmPhiLab {"hEcmPhiLab", "E_{CM} vs PhiLab; E_{CM} [MeV];PhiLab [#circ]", 200, 0, 5, 200, 0, 180};
